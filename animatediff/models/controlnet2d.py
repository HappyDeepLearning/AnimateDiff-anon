...
from diffusers.loaders import FromOriginalControlNetMixin, LoraLoaderMixin, PeftAdapterMixin
...
class ControlNetModel(ModelMixin, ConfigMixin, FromOriginalControlNetMixin, LoraLoaderMixin, PeftAdapterMixin):
    """
    A ControlNet model.
